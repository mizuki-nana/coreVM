...
public:
  ...
  explicit dynamic_object_attribute_not_found_error(corevm::dyobj::attr_key attr_key, corevm::dyobj::dyobj_id id):
    corevm::dyobj::dynamic_object_runtime_error(
      str(boost::format("Attribute %u in object %s not found") % attr_key % corevm::dyobj::dyobj_id_helper::id_to_string(id))
    ),
    attr_key(attr_key),
    id(id)
  {}
...
public:
  ...
  explicit dynamic_object_attribute_cannot_be_deleted_error(corevm::dyobj::attr_key attr_key, corevm::dyobj::dyobj_id id):
    corevm::dyobj::dynamic_object_runtime_error(
      str(boost::format("Attribute %u cannot be deleted from object %s") % attr_key % corevm::dyobj::dyobj_id_helper::id_to_string(id))
    ),
    attr_key(attr_key),
    id(id)
  {}
...
class dynamic_object_id_exceed_limit_error : public corevm::dyobj::dynamic_object_runtime_error {
public:
