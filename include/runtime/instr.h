...
typedef struct instr {
  const corevm::runtime::instr_code code = 0;
  const corevm::runtime::instr_oprd oprd1 = 0;
  const corevm::runtime::instr_oprd oprd2 = 0;
} instr;
...
/* Object instructions */
class instr_handler_new : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_lbobj : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_stobj : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_getattr : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_setattr : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_pop : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_ldobj2 : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_stobj2 : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_delobj : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_delobj2 : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_gethndl : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_sethndl : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_clrhndl : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_objeq : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_objneq : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
...
class instr_handler_uint8 : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_int16 : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_uint16 : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_int32 : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_uint32 : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_int64 : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_uint64 : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_bool : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_dec1 : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_dec2 : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_str : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_ary : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_map : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };

/* Native type conversion instructions */
class instr_handler_2int8 : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_2uint8 : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_2int16 : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_2uint16 : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_2int32 : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_2uint32 : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_2int64 : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_2uint64 : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_2bool : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_2dec1 : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_2dec2 : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_2str : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_2ary : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_2map : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };

/* Complex type instructions */
class instr_handler_strlen : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_strclr : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_strapd : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_strpsh : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_strist : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_strist2 : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_strers : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_strers2 : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_strrplc : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_strswp : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_strsub : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_strsub2 : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_strfnd : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_strfnd2 : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_strrfnd : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_strrfnd2 : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };

class instr_handler_arylen : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_aryemp : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_aryat : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_aryfrt : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_arybak : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_aryapnd : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_arypop : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_aryswp : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_aryclr : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };

class instr_handler_maplen : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_mapemp : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_mapat : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_mapput : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_mapers : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_mapclr : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
class instr_handler_mapswp : public instr_handler { virtual void execute(const corevm::runtime::instr&, corevm::runtime::process&); };
